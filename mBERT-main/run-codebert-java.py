...
CODEBERT_JAVA="pre-trained/codebert-java"
model = RobertaForMaskedLM.from_pretrained(CODEBERT_JAVA)
tokenizer = RobertaTokenizer.from_pretrained(CODEBERT_JAVA)
...
# Load vocab file
my_dict = load_vocab('pre-trained/codebert-java/vocab.json')
