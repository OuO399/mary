...
from transformers import AutoTokenizer, AutoModelForMaskedLM, pipeline, AutoModel,RobertaForMaskedLM,RobertaTokenizer,AutoModelForSeq2SeqLM
...
CODET5="pre-trained/codet5-base"
model = AutoTokenizer.from_pretrained(CODET5)
tokenizer = AutoModel.from_pretrained(CODET5)
