...
public class CodeBERT {
    ...
    public static CodeBERTResult mutate(String maskedSequence,String withoutMaskedMethodStr) {
        numOfCalls++;
        ...
        try {
            ...
            Process p = Runtime.getRuntime().exec(new String[]{"python3","run-graphcodebert.py",maskedSequence,withoutMaskedMethodStr,Integer.toString(Settings.PROCESS_LABEL)});
