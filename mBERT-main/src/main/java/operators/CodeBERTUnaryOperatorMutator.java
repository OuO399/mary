...
public class CodeBERTUnaryOperatorMutator extends CodeBERTOperatorMutator{
    ...
    public MaskedTokenMutants mutate(CtUnaryOperator original) {
        ...
        String withoutMaskedMethodStr = maskedTokenMutants.getFullMethodStr(method);
        CodeBERT.CodeBERTResult result = CodeBERT.mutate(maskedMethodStr,withoutMaskedMethodStr);
