...
def lstm_classify(project,train_version,test_version,data_type,cut_length,train_X,train_Y,test_X,test_Y):
    ...
    for i in range(30):
        ...
        traditional_lstm_out = LSTM(128,name='promise_lstm')(mask_zeros)#(traditional_input)
        ...
        with open('./Deeper_LSTM/res_with_glove_by_version_{}_smote_median_value_1108.txt'.format(cut_length), 'a+', encoding='utf-8') as f:
    ...
    with open('./Deeper_LSTM/res_with_glove_by_version_{}_smote_1108.txt'.format(cut_length), 'a+', encoding='utf-8') as f:
...
def CNN_classify(project,train_version,test_version,data_type,cut_length,train_X,train_Y,test_X,test_Y):
    ...
    for i in range(10):
        ...
        traditional_dropout = Dropout(name='traditional_dropout',rate=0.1)(traditional_flatten_output)
        ...
        with open('./Deeper_CNN/res_with_glove_by_version_{}_median_value_1130_KMeansSMOTE_b64_e200_k5_s2.txt'.format(cut_length), 'a+', encoding='utf-8') as f:
            f.write('{}_{}_{}_{}_{}_{} P:{}  R:{}  F1:{}  A:{}  AUC:{}   MCC:{}\n'.format(
                project,
                train_version,test_version,
                str(i),
    ...
    with open('./Deeper_CNN/res_with_glove_by_version_{}_1130_KMeansSMOTE_b64_e200_k5_s2.txt'.format(cut_length), 'a+', encoding='utf-8') as f:
        f.write('\n')
        f.write('{}_{}_{}_{}_{}_{}_epoch400_withvaild P:{}  R:{}  F1:{}  A:{}  AUC:{}   MCC:{}\n'.format(
            project,
            train_version,test_version,
            "avg",
            data_type,
...
if __name__ == '__main__':
    ...
    # projects_with_version = {'ant':["1.6",'1.7']}
    ...
    projects_with_version = {'ant':['1.5','1.6','1.7'],"jEdit":['4.0','4.1','4.2'],"synapse":['1.0','1.1','1.2'],"camel":['1.4','1.6'],
                                "ivy":['1.4','2.0'],"xalan":['2.4','2.5']}
    # projects_with_version = {"synapse":['1.0','1.1','1.2'],"camel":['1.4','1.6'],
    #                             "ivy":['1.4','2.0'],"xalan":['2.4','2.5'],'ant':['1.5','1.6','1.7'],"jEdit":['4.0','4.1','4.2'],}
